...
public class PopulateTeamSheduleAction extends Action
{
  ...
  public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception
  {
    ...
    try
    {
      ...
      lteamSheduleForms = TeamSheduleForm.getDummyTeamSheduleForms(lteamSheduleForms, seriesForm.getMatches());
