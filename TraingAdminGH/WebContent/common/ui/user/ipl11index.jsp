		...
		<table  style="padding: 0px;">
			<tbody>
				<tr style="padding: 0px;">
					...
					<h1>IPL 2011 Super Cric Team</h1>
					<h3><a href="viewLatestStandings.do"> IPL 2011 - Final
					Standings </a></h3>
					<table  style="padding: 0px;">
						<tr>
							<%
		...
		<table  style="padding: 0px;">
			<tr>
				...
				<table >
					<tbody>
						<tr>
							<th width="190px"><a href="viewBestPlayers.do?id=1">IPL
							Best Players</a></th>
							<th width="190px"><a href="viewBestPlayers.do?id=2">IPL
							Best Batsmen</a></th>
							<th width="190px"><a href="viewBestPlayers.do?id=3">IPL
							Best Bowlers</a></th>
						</tr>
						<%
				...
				<table  style="padding: 0px;">
					<tr>
						<th valign="top" ><a href="viewTeamShedule.do">IPL
			...
			<tr>
				...
				<table width="100%" >
					<tr>
						<th>Super Cric Team - IPL 2011 News Update</th>
					</tr>
				...
				<td align="right" valign="top"><img src="images/iwc.jpg" width="310px"
